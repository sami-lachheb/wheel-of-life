...
After delivery, **ask the user:** _"Would you like to export this presentation to PDF? Perfect for email attachments, embedding in documents, or printing."_
...
If the user declines, stop here. Otherwise, proceed below.
